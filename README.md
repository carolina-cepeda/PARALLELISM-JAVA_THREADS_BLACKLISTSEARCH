...
- Con 200 hilos el overhead es menor que con 500, pero sigue siendo alto. El punto óptimo suele estar cerca del número de núcleos disponibles o un múltiplo pequeño de estos.


2. Cómo se comporta la solución usando tantos hilos de procesamiento como núcleos comparado con el resultado de usar el doble de éste?.

- los hilos que esperan ceden el CPU a otros. Pero más allá de ese punto, los retornos disminuyen rápidamente.

3. De acuerdo con lo anterior, si para este problema en lugar de 100 hilos en una sola CPU se pudiera usar 1 hilo en cada una de 100 máquinas hipotéticas, la ley de Amdahls se aplicaría mejor?. Si en lugar de esto se usaran c hilos en 100/c máquinas distribuidas (siendo c es el número de núcleos de dichas máquinas), se mejoraría?. Explique su respuesta.

- como cada máquina tiene su propio CPU, memoria y caché no habria  overhead ya que no hay contencion de recursos.

- mejora, ya que no copiten por recursos y cada maquina usa todos sus nucleos eficicentemente bajaría la cantidad de overhead.
